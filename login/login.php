...
$client->setClientId('811611328257-bld53j0bl0dbhkn67v9esld9vsodc5ck.apps.googleusercontent.com');
$client->setClientSecret('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');

$client->setRedirectUri('http://localhost/login/login/login.php');
